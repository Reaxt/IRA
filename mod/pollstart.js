...
module.exports = {
  ...
  func:function(message){
    ...
    if(parseInt(things[2]) > 10) return(message.channel.send({embed:utils.embed("malfunction", `I CAN'T COUNT OVER 10 TRY AGAIN`)}))
    if(!things[2]) return(message.channel.send({embed:utils.embed("malfunction", "GIVE ME A NUMBER")}))
