...
module.exports = (expression, content, color, footer) => {
  var url = "https://cdn.discordapp.com/attachments/357705463514660868/650945555916128256/icon.png"
  var Ecolor = "#542948"
  ...
  let result = new Discord.RichEmbed().setTitle("CORE OS").setColor(Ecolor).setThumbnail(url).setDescription(content)
