...
module.exports = {
  ...
  func:function(message){
  	...
  	if(message.member.voice.channel =! message.guild.me.voice.channel) return message.channel.send({embed:utils.embed("sad", "I CAN'T HEAR YOU OVER THERE COME CLOSER")})
